...
def creating_philtrum():
    ...
    bpy.ops.object.vertex_group_select()
    bpy.ops.transform.translate(value=(0,0,-1), constraint_axis=(False, False, False),mirror=False, use_proportional_edit = True,use_proportional_connected=True,proportional_edit_falloff='SMOOTH',proportional_size=7)
    
    bpy.ops.mesh.select_all(action='DESELECT')
    bpy.ops.object.vertex_group_set_active(group=str("eye_bot"))
    bpy.ops.object.vertex_group_select()
    bpy.ops.transform.translate(value=(0,0,1), constraint_axis=(False, False, False),mirror=False, use_proportional_edit = True,use_proportional_connected=True,proportional_edit_falloff='SMOOTH',proportional_size=7)
    bpy.ops.transform.translate(value=(0,0,-1), constraint_axis=(False, False, False),mirror=False, use_proportional_edit = True,use_proportional_connected=True,proportional_edit_falloff='SMOOTH',proportional_size=5)
